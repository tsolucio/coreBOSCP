/*
 * vtigerCRM yiiCPng - web based vtiger CRM Customer Portal
 * Copyright (C) 2011 Opencubed shpk: JPL TSolucio, S.L./StudioSynthesis, S.R.L.
 *
 * This file is part of yiiCPng.
 *
 * yiiCPng is free software; you can redistribute it and/or
 * modify it under the terms of the GNU General Public
 * License as published by the Free Software Foundation; either
 * version 3 of the License, or (at your option) any later version.
 *
 * yiiCPng is distributed in the hope that it will be useful,
...
var tableBrowse = {
    ...
    editRow: function(rowIndex){
        $('#browse tr').eq(rowIndex + 1).appendForm(baseUrl + '/entity/edit', {
    ...
    setup: function(){
        ...
        buttons[lang.get('core', 'yes')] = function(){
            // Do delete request
            $.post(baseUrl + '/entity/' + table + '/deleteid/' + viewEntityId, {}, AjaxResponse.handle);
            $(this).dialog('close');
        };
        $('#dropEntityDialog').dialog({
			modal: true,
			resizable: false,
			autoOpen: false,
            buttons: buttons
